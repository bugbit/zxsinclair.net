...
namespace ZXSinclair.Native
{
    internal static class SDL2
    {
        ...
        {
            return MarshalHelpers.Utf8ToString(SDL_GetError());
        }
        ...
        {
            return MarshalHelpers.Utf8ToString(SDL_GetHint(name));
        }
        ...
        public static class Display
        {
            ...
            {
                return MarshalHelpers.Utf8ToString(GetError(SDL_GetDisplayName(index)));
            }
        ...
        public static class Joystick
        {
            ...
            {
                return MarshalHelpers.Utf8ToString(JoystickName(joystick));
            }
        ...
        public static class GameController
        {
            ...
            public static string GetMapping(IntPtr gamecontroller)
            {
                ...
                string mappingStr = MarshalHelpers.Utf8ToString(nativeStr);
            ...
            {
                return MarshalHelpers.Utf8ToString(SDL_GameControllerName(gamecontroller));
            }
        }
